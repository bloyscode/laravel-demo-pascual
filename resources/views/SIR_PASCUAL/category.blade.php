    ...
    <div class="container mx-auto py-10 px-4">
        ...
        <div class="text-center mb-8">
            <h1 class="text-3xl font-semibold text-gray-800">
                ...
                @elseif(Auth::user()->hasRole('registrar')) Registrar
                @elseif(Auth::user()->hasRole('faculty')) Faculty
                @else Staff
                @endif
            </h1>
        </div>
                ...
                <div x-show="open" x-cloak
                    ...
                    <div class="bg-white rounded-lg shadow-lg max-w-md w-full p-6">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <button @click="open = false" class="text-gray-600 hover:text-red-600">&times;</button>
                        </div>
        ...
        <div class="overflow-x-auto bg-white shadow-lg rounded-lg">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-2 text-sm text-gray-800">
                            ...
                            <form action="{{ route('admin.delete_event',$event->id)}}" method="POST"
                                ...
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="text-center bg-red-500 text-white py-2 px-2 rounded-lg">
                                    Delete
                                </button>
                            </form>
                        </td>
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="px-4 py-4 text-center text-gray-600">No events available</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
